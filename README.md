...
Developed in the PacalABCDotNet integrated environment.

FindDividersOfNumber. Занятия по Pascal. Платформа DotNet FrameWork. Алгоритмы. Простой ввод/вывод. Консольное приложение.
...
Разработано в интегрированной среде PacalABCDotNet.
